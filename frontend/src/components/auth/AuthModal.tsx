...
const AuthModal = () => {
  ...
  return (
    ...
    >
      <div
        className={`relative w-full max-w-lg h-full bg-white dark:bg-gray-900 shadow-2xl overflow-y-auto transition-transform duration-300 ease-out ${
          isVisible ? "translate-x-0" : "translate-x-full"
        }`}
      >
        {/* Close Button */}
        <div className="sticky top-0 z-10 bg-white dark:bg-gray-900 p-5 border-b border-gray-200 dark:border-gray-700">
          <button
